...
class SpmGlm:
    ...
    def get_info_from_spm_mat(self):
        ...
        self.nscans = SPM['SPM']['nscan']
        self.nruns = len(self.nscans)
        self.rawdatafiles = SPM['SPM']['xY']['P']
        self.betafiles = [v['fname'] for v in SPM['SPM']['Vbeta']]
        self.filter_matrices = [k['X0'] for k in SPM['SPM']['xX']['K']]
        self.design_matrix = [k['X'] for k in SPM['SPM']['xX']['X']]
        self.weight = SPM['SPM']['xX']['W']
